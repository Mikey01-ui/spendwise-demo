    ...
    data: {
      ...
      datasets: [
        ...
        },
        {
          label: 'Expense',
          data: expenseData,
          backgroundColor: isDark ? '#D6FF1F' : '#CCF200',
          borderColor: isDark ? 'transparent' : 'rgba(11, 31, 23, 0.25)',
